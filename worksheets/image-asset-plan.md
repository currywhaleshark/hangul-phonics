...
| 파일명 | 단어 | 쓰임 | 생성 우선순위 |
| --- | --- | --- | --- |
| `hat.png` | 모자 | ㅁ 첫소리 카드, 분류 활동, ㅂ 함정 | 필수 |
| `door.png` | 문 | ㅁ 첫소리 카드, 분류 활동 | 필수 |
| `water.png` | 물 | ㅁ 첫소리 카드, 분류 활동 | 필수 |
| `rainbow.png` | 무지개 | ㅁ 첫소리 카드, 분류 활동 | 필수 |
| `slide.png` | 미끄럼틀 | ㅁ 첫소리 카드 | 필수 |
| `banana.png` | 바나나 | ㅂ 첫소리 카드, 분류 활동, ㅁ 함정 | 필수 |
| `bus.png` | 버스 | ㅂ 첫소리 카드, 분류 활동 | 필수 |
| `star.png` | 별 | ㅂ 첫소리 카드, 분류 활동 | 필수 |
| `rain.png` | 비 | ㅂ 첫소리 카드, 분류 활동 | 필수 |
| `basket.png` | 바구니 | ㅂ 첫소리 카드 | 필수 |
