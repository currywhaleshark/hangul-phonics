...
lessons.push({
  folder: "lesson-15-ya-yeo-vowel",
  title: "15레슨 두 줄 세로 모음: 야/여/겨/녀/벼/혀를 만들어요",
  letters: "ㅇ/ㅑ/ㅕ/야/여/겨/녀/벼/혀",
  story: {
    title: "오른쪽에 두 줄 모음이 붙어요",
    read: "오른쪽에 두 줄이 있는 ㅑ와 ㅕ가 와요. ㅇ은 야, 여가 되고, 다른 친구들도 겨, 녀, 벼, 혀로 바뀌어요.",
    panels: [
      { image: "../../../public/아아 아기 야 나뭇가지 노드방출 생성.png", caption: "ㅇ이 ㅑ를 만나, 야!" },
      { image: "../../../public/아아 아기 여 풍선 노드방출 생성.png", caption: "ㅇ이 ㅕ를 만나, 여!" },
      { image: "../../../public/고고 겨 풍선.png", caption: "ㄱ이 ㅕ를 만나, 겨!" },
      { image: "../../../public/하하 혀 풍선.png", caption: "ㅎ이 ㅕ를 만나, 혀!" },
    ],
    teacherNote: "이 레슨에서는 오른쪽에 붙는 ㅑ/ㅕ만 다룬다. ㅛ/ㅠ는 다음 레슨에서 따로 소개한다.",
    footerLeft: "그림 이야기",
    footerRight: "두 줄 세로 모음 ㅑ/ㅕ",
  },
  activities: [
    activity({
      title: "ㅇ과 ㅑ가 만나면 야",
    ...
    activity({
      title: "ㄱ과 ㅕ가 만나면 겨",
      read: "고고 고양이가 여여 두 풍선을 만나 겨! 겨, 겨, 같이 말해요.",
      heroImage: "../../../public/고고 겨 풍선.png",
      traceLetter: "겨",
      buildPieces: ["ㄱ", "ㅕ", "겨"],
      soundSteps: [
        { label: "고고 고양이 ㄱ 소리", sound: "그!" },
        { label: "여여 두 풍선 ㅕ 소리", sound: "여!" },
        { label: "합치면", sound: "겨!" },
      ],
      teacherNote: "ㄱ 오른쪽에 ㅕ를 붙여 겨를 만든다. ㄱ은 짧게, 겨는 한 번에 읽는다.",
      footerRight: "고고와 겨",
    }),
    activity({
      title: "ㄴ과 ㅕ가 만나면 녀",
      read: "나나 나비가 여여 두 풍선을 만나 녀! 녀, 녀, 같이 말해요.",
      heroImage: "../../../public/나나 녀 풍선.png",
      traceLetter: "녀",
      buildPieces: ["ㄴ", "ㅕ", "녀"],
      soundSteps: [
        { label: "나나 나비 ㄴ 소리", sound: "느!" },
        { label: "여여 두 풍선 ㅕ 소리", sound: "여!" },
        { label: "합치면", sound: "녀!" },
      ],
      teacherNote: "ㄴ 오른쪽에 ㅕ를 붙여 녀를 만든다. 소녀 낱말에서는 두 번째 글자 녀만 찾아본다.",
      footerRight: "나나와 녀",
    }),
    activity({
      title: "ㅂ과 ㅕ가 만나면 벼",
      read: "부부 부엉이가 여여 두 풍선을 만나 벼! 벼, 벼, 같이 말해요.",
      heroImage: "../../../public/부부 벼 풍선.png",
      traceLetter: "벼",
      buildPieces: ["ㅂ", "ㅕ", "벼"],
      soundSteps: [
        { label: "부부 부엉이 ㅂ 소리", sound: "브!" },
        { label: "여여 두 풍선 ㅕ 소리", sound: "여!" },
        { label: "합치면", sound: "벼!" },
      ],
      teacherNote: "ㅂ 오른쪽에 ㅕ를 붙여 벼를 만든다. 아이가 낱말 그림에서 벼를 먼저 가리키게 한다.",
      footerRight: "부부와 벼",
    }),
    activity({
      title: "ㅎ과 ㅕ가 만나면 혀",
      read: "하하 하마가 여여 두 풍선을 만나 혀! 혀, 혀, 같이 말해요.",
      heroImage: "../../../public/하하 혀 풍선.png",
      traceLetter: "혀",
      buildPieces: ["ㅎ", "ㅕ", "혀"],
      soundSteps: [
        { label: "하하 하마 ㅎ 소리", sound: "흐!" },
        { label: "여여 두 풍선 ㅕ 소리", sound: "여!" },
        { label: "합치면", sound: "혀!" },
      ],
      teacherNote: "ㅎ 오른쪽에 ㅕ를 붙여 혀를 만든다. 혀를 너무 오래 내미는 놀이보다 글자 모양 찾기에 집중한다.",
      footerRight: "하하와 혀",
      wordCards: {
        focus: "ㅑ/ㅕ",
        title: "야/여/겨/녀/벼/혀가 들어가는 낱말",
        read: "오늘 배운 야, 여, 겨, 녀, 벼, 혀가 들어 있는 쉬운 낱말을 그림으로 만나요.",
        activityTitle: "배운 글자가 들어간 곳을 진하게 봐요",
        cards: [
          ...
          { word: "겨울", focus: "겨", rest: "울", image: "../../../worksheets/assets/word-gyeo-winter.png" },
          {
            word: "소녀",
            image: "../../../worksheets/assets/word-nyeo-girl.png",
            parts: [
              { text: "소" },
              { text: "녀", focus: true },
            ],
          },
          { word: "벼", focus: "벼", rest: "", image: "../../../worksheets/assets/word-byeo-rice.png" },
          { word: "혀", focus: "혀", rest: "", image: "../../../worksheets/assets/word-hyeo-tongue.png" },
        ],
        teacherNote: "낱말 전체 읽기를 요구하지 않고 오늘 배운 야/여/겨/녀/벼/혀 음절만 찾아본다.",
        footerLeft: "배운 글자 야/여/겨/녀/벼/혀",
        footerRight: "ㅑ/ㅕ 낱말카드",
      },
    }),
  ],
  review: {
    sounds: ["야", "여", "겨", "녀", "벼", "혀"],
    builds: [["ㅇ", "ㅑ", "야"], ["ㅇ", "ㅕ", "여"], ["ㄱ", "ㅕ", "겨"], ["ㄴ", "ㅕ", "녀"], ["ㅂ", "ㅕ", "벼"], ["ㅎ", "ㅕ", "혀"]],
    footerRight: "두 줄 세로 모음 ㅑ/ㅕ",
  },
});
lessons.push({
  folder: "lesson-16-yo-yu-vowel",
  title: "16레슨 두 줄 가로 모음: 요/유/교/규/표/퓨/휴를 만들어요",
  letters: "ㅇ/ㅛ/ㅠ/요/유/교/규/표/퓨/휴",
  story: {
    title: "아래에 두 줄 모음이 붙어요",
    read: "아래에 두 줄이 있는 ㅛ와 ㅠ가 와요. ㅇ은 요, 유가 되고, 다른 친구들도 교, 규, 표, 퓨, 휴로 바뀌어요.",
    panels: [
      { image: "../../../public/요요 그네 시안.png", caption: "ㅇ이 ㅛ를 만나, 요!" },
      { image: "../../../public/유유 의자 시안.png", caption: "ㅇ이 ㅠ를 만나, 유!" },
      { image: "../../../public/고고 교 새시안3.png", caption: "ㄱ이 ㅛ를 만나, 교!" },
      { image: "../../../public/하하 휴 의자.png", caption: "ㅎ이 ㅠ를 만나, 휴!" },
    ],
    teacherNote: "이 레슨에서는 아래에 붙는 ㅛ/ㅠ만 다룬다. 이전 레슨의 ㅑ/ㅕ와 자리를 비교해 보되 한꺼번에 암기시키지 않는다.",
    footerLeft: "그림 이야기",
    footerRight: "두 줄 가로 모음 ㅛ/ㅠ",
  },
  activities: [
    activity({
      title: "ㅇ과 ㅛ가 만나면 요",
    ...
    activity({
      title: "ㄱ과 ㅛ가 만나면 교",
      read: "고고 고양이가 요요 그네를 만나 교! 교, 교, 같이 말해요.",
      heroImage: "../../../public/고고 교 새시안3.png",
      traceLetter: "교",
      buildPieces: ["ㄱ", "ㅛ", "교"],
      soundSteps: [
        { label: "고고 고양이 ㄱ 소리", sound: "그!" },
      ...
      teacherNote: "ㄱ 아래에 ㅛ를 붙여 교를 만든다. 교실 그림과 연결해 오늘 글자 교만 찾아본다.",
      footerRight: "고고와 교",
    }),
    activity({
      title: "ㄱ과 ㅠ가 만나면 규",
      read: "고고 고양이가 유유 의자를 만나 규! 규, 규, 같이 말해요.",
      heroImage: "../../../public/고고 규 새시안.png",
      traceLetter: "규",
      buildPieces: ["ㄱ", "ㅠ", "규"],
      soundSteps: [
        { label: "고고 고양이 ㄱ 소리", sound: "그!" },
      ...
      teacherNote: "ㄱ 아래에 ㅠ를 붙여 규를 만든다. 규칙 그림은 '약속을 지켜요' 정도로 가볍게 연결한다.",
      footerRight: "고고와 규",
    }),
    activity({
      title: "ㅍ과 ㅛ가 만나면 표",
      read: "푸푸 풍선이 요요 그네를 만나 표! 표, 표, 같이 말해요.",
      heroImage: "../../../public/푸푸 표 그네.png",
      traceLetter: "표",
      buildPieces: ["ㅍ", "ㅛ", "표"],
      soundSteps: [
        { label: "푸푸 풍선 ㅍ 소리", sound: "프!" },
        { label: "요요 그네 ㅛ 소리", sound: "요!" },
        { label: "합치면", sound: "표!" },
      ],
      teacherNote: "ㅍ 아래에 ㅛ를 붙여 표를 만든다. 표범 낱말카드는 표 글자에만 집중한다.",
      footerRight: "푸푸와 표",
    }),
    activity({
      title: "ㅍ과 ㅠ가 만나면 퓨",
      read: "푸푸 풍선이 유유 의자를 만나 퓨! 퓨, 퓨, 같이 말해요.",
      heroImage: "../../../public/푸푸 퓨 의자.png",
      traceLetter: "퓨",
      buildPieces: ["ㅍ", "ㅠ", "퓨"],
      soundSteps: [
        { label: "푸푸 풍선 ㅍ 소리", sound: "프!" },
      ...
      teacherNote: "ㅍ 아래에 ㅠ를 붙여 퓨를 만든다. 퓨마 낱말은 첫 글자 퓨만 찾아보게 한다.",
      footerRight: "푸푸와 퓨",
    }),
    activity({
      title: "ㅎ과 ㅠ가 만나면 휴",
      read: "하하 하마가 유유 의자를 만나 휴! 휴, 휴, 같이 말해요.",
      heroImage: "../../../public/하하 휴 의자.png",
      traceLetter: "휴",
      buildPieces: ["ㅎ", "ㅠ", "휴"],
      soundSteps: [
        { label: "하하 하마 ㅎ 소리", sound: "흐!" },
      ...
      teacherNote: "ㅎ 아래에 ㅠ를 붙여 휴를 만든다. 활동 뒤에는 요/유와 교/규/표/퓨/휴를 나누어 복습한다.",
      footerRight: "하하와 휴",
      wordCards: {
        focus: "ㅛ/ㅠ",
        title: "요/유/교/규/표/퓨/휴가 들어가는 낱말",
        read: "오늘 배운 요, 유, 교, 규, 표, 퓨, 휴가 들어 있는 쉬운 낱말을 그림으로 만나요.",
        activityTitle: "배운 글자가 들어간 곳을 진하게 봐요",
        cards: [
          ...
          { word: "교실", focus: "교", rest: "실", image: "../../../worksheets/assets/word-gyo-classroom.png" },
          { word: "규칙", focus: "규", rest: "칙", image: "../../../worksheets/assets/word-gyu-rule.png" },
          { word: "표범", focus: "표", rest: "범", image: "../../../worksheets/assets/word-pyo-leopard.png" },
          { word: "퓨마", focus: "퓨", rest: "마", image: "../../../worksheets/assets/word-pyu-puma.png" },
          { word: "휴지", focus: "휴", rest: "지", image: "../../../worksheets/assets/word-hyu-tissue.png" },
        ],
        teacherNote: "낱말 전체 읽기를 요구하지 않고 오늘 배운 요/유/교/규/표/퓨/휴 음절만 찾아본다.",
        footerLeft: "배운 글자 요/유/교/규/표/퓨/휴",
        footerRight: "ㅛ/ㅠ 낱말카드",
      },
    }),
  ],
  review: {
    sounds: ["요", "유", "교", "규", "표", "퓨", "휴"],
    builds: [["ㅇ", "ㅛ", "요"], ["ㅇ", "ㅠ", "유"], ["ㄱ", "ㅛ", "교"], ["ㄱ", "ㅠ", "규"], ["ㅍ", "ㅛ", "표"], ["ㅍ", "ㅠ", "퓨"], ["ㅎ", "ㅠ", "휴"]],
    footerRight: "두 줄 가로 모음 ㅛ/ㅠ",
  },
});
lessons.push({
  folder: "lesson-17-wa-vowel",
  title: "17레슨 오오 상자와 아아 나뭇가지: 와/과를 만들어요",
  letters: "ㅗ/ㅏ/ㅘ/와/과",
  story: {
    title: "오와 아가 만나 와가 돼요",
    read: "오오 상자 위에 아아 아기가 올라가 나뭇가지를 들어요. 오, 아, 둘이 합쳐 와! 하고 말해요.",
    panels: [
      { image: "../../../public/오오 상자 시안.png", caption: "오오 상자가 아래에 있어요." },
      { image: "../../../public/아아 아기 나뭇가지 시안.png", caption: "아아 아기가 나뭇가지를 들어요." },
      { image: "../../../public/아아 아기 와 오오상자 나뭇가지.png", caption: "오와 아가 만나, 와!" },
    ],
    teacherNote: "ㅘ는 ㅗ와 ㅏ가 합쳐진 모음임을 그림으로만 가볍게 보여 준다. 분석보다 '오, 아, 와'의 입 움직임을 따라 말하는 데 집중한다.",
    footerLeft: "그림 이야기",
    footerRight: "오 + 아 = 와",
  },
  activities: [
    activity({
      title: "ㅇ과 ㅘ가 만나면 와",
      read: "오오 상자 위에 아아 나뭇가지가 올라가 와! 오, 아, 와를 차례로 말해요.",
      heroImage: "../../../public/아아 아기 와 오오상자 나뭇가지.png",
      traceLetter: "와",
      buildPieces: ["ㅇ", "ㅘ", "와"],
      soundSteps: [
        { label: "오오 상자 ㅗ 소리", sound: "오!" },
        { label: "아아 나뭇가지 ㅏ 소리", sound: "아!" },
        { label: "합치면", sound: "와!" },
      ],
      teacherNote: "큰 글자 와를 손가락으로 따라가며 ㅗ와 ㅏ가 붙은 모양을 본다. 쓰기보다 '오-아-와' 소리 합치기를 먼저 한다.",
      footerRight: "오오 상자와 아아 나뭇가지",
    }),
    activity({
      title: "ㄱ과 ㅘ가 만나면 과",
      read: "고고 고양이도 오오 상자 위에서 아아 나뭇가지를 들어 과! 그, 와, 과를 차례로 말해요.",
      heroImage: "../../../public/고고 과 오오상자 나뭇가지.png",
      traceLetter: "과",
      buildPieces: ["ㄱ", "ㅘ", "과"],
      soundSteps: [
        { label: "고고 고양이 ㄱ 소리", sound: "그!" },
        { label: "오와 아가 합친 ㅘ 소리", sound: "와!" },
        { label: "합치면", sound: "과!" },
      ],
      teacherNote: "ㄱ 오른쪽에 ㅘ를 붙여 과를 만든다. 와를 먼저 읽고 과로 이어 읽으며 같은 ㅘ 모양을 찾아본다.",
      footerRight: "고고와 ㅘ",
      wordCards: {
        focus: "ㅘ",
        title: "와/과가 들어가는 낱말",
        read: "와와 과가 들어 있는 쉬운 낱말을 그림으로 만나요.",
        activityTitle: "ㅘ가 들어간 글자를 진하게 봐요",
        cards: [
          { word: "와플", focus: "와", rest: "플", image: "../../../worksheets/assets/word-wa-waffle.png" },
          {
            word: "치와와",
            image: "../../../worksheets/assets/word-wa-chihuahua.png",
            parts: [
              { text: "치" },
              { text: "와", focus: true },
              { text: "와", focus: true },
          ...
          { word: "과자", focus: "과", rest: "자", image: "../../../worksheets/assets/word-gwa-snack.png" },
          {
            word: "사과",
            image: "../../../worksheets/assets/word-gwa-apple.png",
            parts: [
              { text: "사" },
              { text: "과", focus: true },
            ],
        ...
        teacherNote: "낱말 전체 읽기를 요구하지 않고 와/과 안에 들어 있는 ㅘ 모양만 찾아본다.",
        footerLeft: "배운 글자 와/과",
        footerRight: "ㅘ 낱말카드",
      },
    }),
  ],
